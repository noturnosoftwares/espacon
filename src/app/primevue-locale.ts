/**
 * Locale **pt-BR** global do PrimeVue (regra do produto: nada é apresentado ao
 * usuário fora do português do Brasil). Aplicado no `main.ts` via `locale` do
 * `PrimeVue` config — vale para o calendário (`DatePicker`), paginação, mensagens
 * de vazio, diálogos, etc. Sem isto, os componentes nascem em inglês.
 */
export const PT_BR_LOCALE = {
  ...
  aria: {
    ...
    moveBottom: 'Mover para baixo de tudo',
