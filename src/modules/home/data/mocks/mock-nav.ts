...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'pais', label: 'País', icon: 'globe', route: '/paises', status: 'available' },
      { id: 'estado', label: 'Estado', icon: 'map', route: '/estados', status: 'available' },
      { id: 'cidade', label: 'Cidade', icon: 'map-marker', route: '/cidades', status: 'available' },
